...
Ball *StageOneBall::cloneBall() {return new StageOneBall(*this);}

int StageOneBall::BallType()
{
    return BALLTYPE_STAGEONEBALL;
}


//StageThreeBall::render(QPainter &painter, const QVector2D &offset){
//    painter.setBrush(m_brush);
